        ...
        <div className="bg-gradient-to-br from-[#302357] via-[#080416] to-[#000000] text-white min-h-screen flex flex-col justify-between relative overflow-hidden">
            <div className="px-6 py-12 md:px-20 md:py-16">
                ...
                <img
                    ...
                    alt="earth"
                    className="absolute right-0 -top-20 bottom-0 w-[400px] h-[700px] object-cover z-0 opacity-90 pointer-events-none"
                />
            </div>
                <div
                    ref={bottomRef}
                    className="bg-[#1e1e3f] text-center text-sm md:text-base mt-12 rounded-t-3xl px-4 lg:px-10 py-6 flex flex-col md:flex-row justify-between items-center z-10"
                >
