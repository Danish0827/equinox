...
const MainServices = () => {
    ...
    return (
        <div className="pt-16 border-b-2 border-cyan-400 relative overflow-hidden min-h-screen bg-gradient-to-tr from-[#11071f] via-[#11071f] to-[#210a42] text-white">
            ...
            <div className='px-3 pb-3'>
                ...
                >
                    {services.map((item, idx) => (
                        <div
                            key={idx}
                            className="py-8 flex flex-col items-center justify-center text-white text-sm font-medium rounded-lg"
                        >
                            <img
                                src={item.icon}
                                alt={item.name}
                                className="h-14 mb-4 fade-item"
                            />
                            <div className="text-center text-sm md:text-base lg:text-xl">{item.name}</div>
                        </div>
                    ))}
                </div>
            </div>
